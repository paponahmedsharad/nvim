...
require("lazy").setup({
    ...
    { "nvim-lualine/lualine.nvim",                 enabled = true },     --> Status Line (bottom bar)
...

    {
        ...
        opts = {
            ...
            dashboard = {
                sections = {
                    { pane = 1, section = "terminal",               cmd = "bash ~/newlogo.sh", height = 9,        indent = -1,        padding = { 0, 0 } },
                    { pane = 1, section = "startup",                padding = { 2, 0 } },
                    { pane = 1, title = "K E Y M A P S",            align = "center",          indent = 1,        padding = { 0, 0 }, },
                    { pane = 1, section = "keys",                   indent = 2,                padding = { 1, 0 } },

                    { pane = 2, title = "R E C E N T   F I  L E S", align = "center",          indent = 1,        padding = { 0, 0 }, },
                    { pane = 2, section = "recent_files",           limit = 8,                 indent = 2,        padding = 1 },
                    { pane = 2, title = "P R O J E C T S",          align = "center",          indent = 1,        padding = { 0, 2 }, },
                    { pane = 2, section = "projects",               limit = 8,                 indent = 2,        padding = 1 },
                },
            },
        },
        ...
        keys = {
            ...
            { "<leader>N", desc = "Neovim News", function() Snacks.win({ file = vim.api .nvim_get_runtime_file("doc/news.txt", false)[1], width = 0.8, height = 0.8, wo = { spell = false, wrap = false, signcolumn = "yes", statuscolumn = " ", conceallevel = 3, }, }) end, }
        },
    ...
    -- { "Pheon-Dev/pigeon" }, { dir = "~/onecolor.nvim" },
    -- { dir = "~/codeRuner.nvim" },
    { dir = "~/repo/neodark.nvim" },
