...
cs("alert", { -- [CMD] multiline vim.cmd{{{
  t { "alert(" },
  i(1, ""),
  t { ");" },
  i(2, ""),
...
cs("im", { -- [CMD] multiline vim.cmd{{{
  t { "import '" },
  i(1, ""),
  t { "';" },
})

cs("reactb", { -- [CMD] multiline vim.cmd{{{
...
cs("cl", { t "console.log(", i(1, ""), t ")" }, { "jcl" }) -- console.log
